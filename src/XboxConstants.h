/**
 * XboxControllerConstants.h
 */

#ifndef SRC_XBOXCONSTANTS_H_
#define SRC_XBOXCONSTANTS_H_
...
public:
    ...
    static constexpr int LEFT_JOYSTICK_BUTTON = 9;
    static constexpr int RIGHT_JOYSTICK_BUTTON = 10;
};
